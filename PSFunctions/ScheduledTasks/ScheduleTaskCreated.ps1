...
$A= Get-WinEvent -FilterHashtable @{ Id=4698; Path = $Path }
$global:ScheduleTaskCreatedcount=0
$A | ForEach-Object -process{
	...
	$global:ScheduleTaskCreatedcount++
	$Logon

} }
"Number of ScheduleTaskCreated events:"+ $ScheduleTaskCreatedcount